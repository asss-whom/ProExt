...
impl Entity {
    ...
    pub fn update_pawn(
        ...
        if !self
            .pawn
            .bone_data
            .update_bone_data(player_pawn_address, window_info, view)
        {
            return false;
        }
...
impl PlayerController {
    ...
    pub fn get_player_name(&mut self) -> bool {
        ...
        if !rpm(
            self.address + Offsets::CBasePlayerController::m_iszPlayerName as u64,
            &mut buffer,
            260,
        ) {
            return false;
    ...
    pub fn get_player_pawn_address(&mut self) -> u64 {
        ...
        if !rpm_offset(
            self.address,
            Offsets::CCSPlayerController::m_hPlayerPawn as u64,
            &mut self.pawn,
        ) {
            return 0;
        }
...
impl PlayerPawn {
    ...
    pub fn get_weapon(&mut self) -> bool {
        ...
        if !rpm_offset(
            clipping_weapon,
            Offsets::C_BaseEntity::m_nSubclassID as u64 + 0x08,
            &mut weapon_data,
        ) {
            return false;
        }
        ...
        if !rpm_offset(
            weapon_data,
            Offsets::CBasePlayerWeaponVData::m_iMaxClip1 as u64,
            &mut self.weapon_max_ammo,
        ) {
            return false;
        }
        ...
        if !rpm_offset(
            clipping_weapon,
            Offsets::C_BasePlayerWeapon::m_iClip1 as u64,
            &mut self.weapon_ammo,
        ) {
            return false;
        }
    ...
    pub fn get_fov(&mut self) -> bool {
        ...
        if !rpm_offset(
            self.address,
            Offsets::C_BasePlayerPawn::m_pCameraServices as u64,
            &mut camera_services,
        ) {
            return false;
        }
