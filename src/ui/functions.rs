use imgui::{ColorEditFlags, ImColor32, Style, StyleColor, Ui};
...
pub fn apply_style(style: &mut Style, default: Style) {
    ...
    style.colors[StyleColor::TextDisabled as usize] =
        color_to_style_color(config.style.colors.text_disabled);

    style.colors[StyleColor::WindowBg as usize] =
        color_to_style_color(config.style.colors.window_bg);
    ...
    style.colors[StyleColor::BorderShadow as usize] =
        color_to_style_color(config.style.colors.border_shadow);

    style.colors[StyleColor::FrameBg as usize] = color_to_style_color(config.style.colors.frame_bg);
    style.colors[StyleColor::FrameBgHovered as usize] =
        color_to_style_color(config.style.colors.frame_bg_hovered);
    style.colors[StyleColor::FrameBgActive as usize] =
        color_to_style_color(config.style.colors.frame_bg_active);
    ...
    style.colors[StyleColor::TitleBgCollapsed as usize] =
        color_to_style_color(config.style.colors.title_bg_collapsed);
    style.colors[StyleColor::TitleBgActive as usize] =
        color_to_style_color(config.style.colors.title_bg_active);

    style.colors[StyleColor::TextSelectedBg as usize] =
        color_to_style_color(config.style.colors.text_selected_bg);
    style.colors[StyleColor::CheckMark as usize] =
        color_to_style_color(config.style.colors.checkmark);

    style.colors[StyleColor::ScrollbarBg as usize] =
        color_to_style_color(config.style.colors.scrollbar_bg);
    style.colors[StyleColor::ScrollbarGrab as usize] =
        color_to_style_color(config.style.colors.scrollbar_grab);
    style.colors[StyleColor::ScrollbarGrabHovered as usize] =
        color_to_style_color(config.style.colors.scrollbar_grab_hovered);
    style.colors[StyleColor::ScrollbarGrabActive as usize] =
        color_to_style_color(config.style.colors.scrollbar_grab_active);

    style.colors[StyleColor::SliderGrab as usize] =
        color_to_style_color(config.style.colors.slider_grab);
    style.colors[StyleColor::SliderGrabActive as usize] =
        color_to_style_color(config.style.colors.slider_grab_active);
    ...
    style.colors[StyleColor::ButtonHovered as usize] =
        color_to_style_color(config.style.colors.button_hovered);
    style.colors[StyleColor::ButtonActive as usize] =
        color_to_style_color(config.style.colors.button_active);
    ...
    style.colors[StyleColor::TabHovered as usize] =
        color_to_style_color(config.style.colors.tab_hovered);
    style.colors[StyleColor::TabActive as usize] =
        color_to_style_color(config.style.colors.tab_active);

    style.colors[StyleColor::Separator as usize] =
        color_to_style_color(config.style.colors.separator);
}
